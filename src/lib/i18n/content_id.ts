...
export const contactInfo = {
  ...
  whatsappTemplate: "Halo MSA Education, saya ingin konsultasi tentang program belajar.",
  email: "[EMAIL_ADDRESS]",
...
export const seoConfig = {
  ...
  keywords: [
    ...
    "private tutoring Jakarta",
    "private tutor Jakarta",
    "home tutoring Jakarta",
    "home tutor Jakarta Indonesia",
    "private lesson Jakarta",
    "private teacher Jakarta",
    "kids tutoring Jakarta",
    "children tutoring Jakarta",
    "child education Jakarta",
    "early childhood education Jakarta",
    "elementary school tutoring Jakarta",
    "kindergarten tutoring Jakarta",
    "toddler learning Jakarta",
    "preschool tutoring Jakarta",
    "special needs education Jakarta",
    "special needs tutoring Jakarta",
    "special needs teacher Jakarta",
    "learning support Jakarta",
    "academic support Jakarta",
    "homework help Jakarta",
    "reading tutoring Jakarta",
    "math tutoring Jakarta",
    "homeschooling Jakarta Indonesia",
    "homeschool support Jakarta",
    "homeschool tutor Jakarta",
    "inclusive education Jakarta",
    "personalized learning Jakarta",
    "one on one tutoring Jakarta",
    "after school tutoring Jakarta",
    "best tutor Jakarta",
    "best private tutor Jakarta",
    "affordable tutoring Jakarta",
    "home visit tutor Jakarta",
    "education service Jakarta",
    "tutoring service Jakarta",
    "Kelapa Gading tutor",
    "Sunter tutor",
    "North Jakarta tutor",
    "Central Jakarta tutor",
    "East Jakarta tutor",
    "Mindful Supportive Adaptive education",
    "MSA Mindful Supportive Adaptive",

    // ---- LONG-TAIL ID (Intent-based) ----
    "cari les privat untuk anak",
    "les privat terbaik untuk anak TK",
    "les privat terbaik untuk anak SD",
    "les yang bagus untuk anak",
    "les privat datang ke rumah",
    "guru les datang ke rumah Jakarta",
    "guru privat yang sabar",
    "les anak untuk usia dini",
    "les belajar membaca untuk anak",
    "les belajar menulis untuk anak",
    "les belajar berhitung untuk anak",
    "pendampingan belajar anak di rumah",
    "les anak berkebutuhan khusus Jakarta",
    "guru pendamping anak ABK",
    "terapi belajar anak ABK Jakarta",
    "stimulasi belajar anak usia dini",
    "persiapan masuk SD",
    "les persiapan masuk SD Jakarta",
    "les membaca untuk anak TK",
    "bimbel privat Jakarta murah",
    "belajar nyaman di rumah",
    "guru les anak sabar dan kreatif",
  ],
